...
import com.triton.nanny.doctor.DoctorAppointmentDetailsActivity;
import com.triton.nanny.doctor.PrescriptionActivity;
import com.triton.nanny.doctor.VideoCallDoctorActivity;
import com.triton.nanny.interfaces.OnAppointmentCancel;
import com.triton.nanny.interfaces.StartAppointmentListener;
import com.triton.nanny.requestpojo.DoctorStartAppointmentRequest;
import com.triton.nanny.responsepojo.AppointmentsUpdateResponse;
import com.triton.nanny.responsepojo.DoctorAppointmentsResponse;
...
public class DoctorNewAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if(newAppointmentResponseList.get(position).getAmount() != null){
            holder.txt_service_cost.setText("RM  "+newAppointmentResponseList.get(position).getAmount());
        }
