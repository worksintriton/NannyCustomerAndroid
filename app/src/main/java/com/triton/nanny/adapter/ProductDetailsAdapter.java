...
import com.triton.nanny.doctor.shop.DoctorCancelOrderActivity;
import com.triton.nanny.doctor.shop.DoctorTrackOrderActivity;
import com.triton.nanny.petlover.PetVendorCancelOrderActivity;

import com.triton.nanny.petlover.TrackOrderActivity;
import com.triton.nanny.responsepojo.PetLoverVendorOrderDetailsResponse;
import com.triton.nanny.serviceprovider.shop.SPCancelOrderActivity;
import com.triton.nanny.serviceprovider.shop.SPTrackOrderActivity;
       ...
       /* if (product_details.get(position).getProduct_id() != null) {
        ...
        if (product_details.get(position).getProduct_price() != 0 && product_details.get(position).getProduct_count() != 0) {
            if (product_details.get(position).getProduct_count() == 1) {
                holder.txt_products_price.setText("RM  " + product_details.get(position).getProduct_price() + " (" + product_details.get(position).getProduct_count() + " item )");
            } else {
                holder.txt_products_price.setText("RM  " + product_details.get(position).getProduct_price() + " (" + product_details.get(position).getProduct_count() + " items )");

            }
        }
        else { if (product_details.get(position).getProduct_count() == 1) {
                holder.txt_products_price.setText("RM  " + 0 + " (" + product_details.get(position).getProduct_count() + " item )");
            }
            else {
                holder.txt_products_price.setText("RM  " + 0 + " (" + product_details.get(position).getProduct_count() + " items )");
