...
import com.triton.nanny.vendor.EditManageProdcutsActivity;
   ...
   private final OnItemCheckProduct onItemCheckProduct;
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if(manageProductsListResponseList.get(position).getProduct_price() != 0) {
            holder.txt_prod_price.setText("RM  " + manageProductsListResponseList.get(position).getProduct_price());
        }
