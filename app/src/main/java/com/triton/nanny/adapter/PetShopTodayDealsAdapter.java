...
import com.triton.nanny.doctor.shop.DoctorProductDetailsActivity;
import com.triton.nanny.petlover.ProductDetailsActivity;
import com.triton.nanny.responsepojo.ShopDashboardResponse;
...
public class PetShopTodayDealsAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if(today_special.get(position).getProduct_price() != 0){
            holder.txt_products_price.setText("RM  "+today_special.get(position).getProduct_price());
        }else{
        ...
        if(today_special.get(position).getProduct_discount_price() != 0){
            ...
            holder.txt_product_discount_price.setText("RM  "+today_special.get(position).getProduct_discount_price());
            ...
            holder.txt_product_discount_price.setText("RM  "+0);
