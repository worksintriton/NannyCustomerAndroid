...
import com.triton.nanny.interfaces.OnAppointmentComplete;

import com.triton.nanny.responsepojo.SPAppointmentResponse;
import com.triton.nanny.serviceprovider.SPAppointmentDetailsActivity;
...
public class SPNewAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if(newAppointmentResponseList.get(position).getService_amount() != null){
            holder.txt_service_cost.setText("RM  "+newAppointmentResponseList.get(position).getService_amount());
        }
