...
import com.triton.nanny.petlover.ProductDetailsActivity;
import com.triton.nanny.responsepojo.CartDetailsResponse;
import com.triton.nanny.serviceprovider.shop.SPProductDetailsActivity;
...
public class Cart_Adapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Cart_Adapter(Context context, List<CartDetailsResponse.DataBean> data, AddandRemoveProductListener addandRemoveProductListener, String TAG) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if (data.get(position).getProduct_id().getDiscount_amount() != 0) {
            ...
            holder.txt_original_amount.setText("RM  " + data.get(position).getProduct_id().getDiscount_amount());

        }else{
            holder.txt_original_amount.setVisibility(View.GONE);
        }
        if (data.get(position).getProduct_id().getCost() != 0) {
            holder.txt_discount_amount.setText("RM  " + data.get(position).getProduct_id().getCost());
        }
        ...
        holder.rl_root.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fromactivity!=null&&fromactivity.equals("SPCartActivity")){
