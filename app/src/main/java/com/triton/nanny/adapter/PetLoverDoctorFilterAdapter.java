...
import com.triton.nanny.petlover.BookAppointmentActivity;
import com.triton.nanny.petlover.DoctorClinicDetailsActivity;
import com.triton.nanny.responsepojo.FilterDoctorResponse;
...
public class PetLoverDoctorFilterAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if(doctorFilterDetailsResponseList.get(position).getAmount() != 0) {
            holder.txt_price.setText("RM  " +doctorFilterDetailsResponseList.get(position).getAmount() + "");
        }else {
