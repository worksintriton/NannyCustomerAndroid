...
import com.triton.nanny.requestpojo.VendorCancelsOrderRequest;
import com.triton.nanny.requestpojo.VendorConfirmsOrderRequest;
import com.triton.nanny.requestpojo.VendorDispatchesOrderRequest;
import com.triton.nanny.requestpojo.VendorFetchOrderDetailsIdRequest;
import com.triton.nanny.responsepojo.VendorCancelsOrderResponse;
import com.triton.nanny.responsepojo.VendorConfirmsOrderResponse;
import com.triton.nanny.responsepojo.VendorDispatchesOrderResponse;
import com.triton.nanny.responsepojo.VendorFetchOrderDetailsResponse;
...
//        bottom_navigation_view.setOnNavigationItemSelectedListener(this);
    ...
    private void setView() {
        ...
        if (product_pr != 0) {
            txt_products_price.setText(" RM  " + product_pr);
        }else{
        ...
        if (order_total != 0) {
            txt_total_order_cost.setText(" RM  "+order_total);
        }else{
            txt_total_order_cost.setText(" RM  "+0);
        }
