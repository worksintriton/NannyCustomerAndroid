package com.triton.nanny.vendor;
...
import com.triton.nanny.adapter.ProductDetailsVendorAdapter;
import com.triton.nanny.api.APIClient;
import com.triton.nanny.api.RestApiInterface;
import com.triton.nanny.interfaces.OnItemCheckConfirmStatus;
import com.triton.nanny.interfaces.OnItemCheckDispatchStatus;
import com.triton.nanny.interfaces.OnItemCheckRejectStatus;
import com.triton.nanny.requestpojo.VendorOrderDetailsListRequest;
import com.triton.nanny.requestpojo.VendorOrderUpdateDispatchRequest;
import com.triton.nanny.requestpojo.VendorOrderUpdateRejectRequest;
import com.triton.nanny.requestpojo.VendorOrderUpdateRequest;
                    ...
                    if(response.body().getCode() == 200){
                        ...
                        if(response.body().getData()!=null){
                            ...
                            if(response.body().getData().getOrder_details().getOrder_price()!=0){
                                txt_products_price.setText("RM  "+response.body().getData().getOrder_details().getOrder_price());
                            }
                            ...
                            if (response.body().getData().getOrder_details().getOrder_price() != 0 && response.body().getData().getOrder_details().getOrder_product() != 0) {
                                if (response.body().getData().getOrder_details().getOrder_product() == 1) {
                                    txt_products_price.setText("RM  " + response.body().getData().getOrder_details().getOrder_price() + " (" + response.body().getData().getOrder_details().getOrder_product() + " product )");
                                } else {
                                    txt_products_price.setText("RM  " + response.body().getData().getOrder_details().getOrder_price() + " (" + response.body().getData().getOrder_details().getOrder_product() + " products )");

                                }
                            }
                            else { if (response.body().getData().getOrder_details().getOrder_product() == 1) {
                                txt_products_price.setText("RM  " + 0 + " (" + response.body().getData().getOrder_details().getOrder_product() + " product )");
                            } else {
                                txt_products_price.setText("RM  " + 0 + " (" + response.body().getData().getOrder_details().getOrder_product() + " products )"); } }
                            ...
                            if(response.body().getData().getOrder_details().getOrder_price() !=0){
                                txt_total_order_cost.setText("RM  "+response.body().getData().getOrder_details().getOrder_price());
                            }
