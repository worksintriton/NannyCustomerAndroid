...
import com.triton.nanny.adapter.ManageProductsListAdapter;
import com.triton.nanny.api.APIClient;
import com.triton.nanny.api.RestApiInterface;
import com.triton.nanny.interfaces.ManageProductsDealsListener;
import com.triton.nanny.interfaces.OnItemCheckProduct;
import com.triton.nanny.requestpojo.ApplyMultiProdDiscountRequest;
import com.triton.nanny.requestpojo.ApplySingleDiscountCalRequest;
import com.triton.nanny.requestpojo.ApplySingleDiscountRequest;
import com.triton.nanny.requestpojo.ManageProductsListRequest;
import com.triton.nanny.requestpojo.TodayDealsClearRequest;
import com.triton.nanny.responsepojo.ApplyMultiProdDiscountResponse;
import com.triton.nanny.responsepojo.ApplySingleDiscountCalResponse;
import com.triton.nanny.responsepojo.ApplySingleDiscountResponse;
import com.triton.nanny.responsepojo.ManageProductsListResponse;
                    ...
                    if (200 == response.body().getCode()) {
                        ...
                        if (response.body().getData() != null) {
                            if(discountstatus){
                                ...
                                txt_discount_price.setText("RM  "+response.body().getData().getDiscount_amount());
                            }
                            txt_cost.setText("RM  " +response.body().getData().getCost());
