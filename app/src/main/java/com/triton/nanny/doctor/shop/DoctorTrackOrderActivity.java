package com.triton.nanny.doctor.shop;
...
public class DoctorTrackOrderActivity extends AppCompatActivity implements View.OnClickListener {
                    ...
                    if(response.body().getCode() == 200){
                        ...
                        if(response.body().getData()!=null){
                            ...
                            if(response.body().getData().getProduct_price()!=0){
                                txt_products_price.setText("RM  "+response.body().getData().getProduct_price());
                            }
                            ...
                            if(response.body().getData().getProduct_price() !=0){
                                txt_total_order_cost.setText("RM  "+response.body().getData().getProduct_price());
                            }
