...
import com.triton.nanny.activity.location.PickUpLocationAddNewAddressSPActivity;
import com.triton.nanny.activity.location.ShippingAddressAddSPActivity;
import com.triton.nanny.api.APIClient;
import com.triton.nanny.api.RestApiInterface;

import com.triton.nanny.petlover.ShippingAddressEditActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if (grand_total!=0){
                ...
                txt_grand_total.setText("RM  "+ grand_total);
            }
