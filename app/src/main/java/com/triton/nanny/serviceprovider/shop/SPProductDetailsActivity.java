...
import com.triton.nanny.requestpojo.DoctorProductFavListCreateRequest;
...
import com.triton.nanny.serviceprovider.SPProfileScreenActivity;
...
//        });
    ...
    private void showVendorDetails() {
        ...
        try {
            ...
            dialog = new Dialog(SPProductDetailsActivity.this);
    ...
    public void onBackPressed() {
        ...
        if(fromactivity != null && fromactivity.equalsIgnoreCase("SearchDoctorActivity")){
            Intent intent = new Intent(SPProductDetailsActivity.this, SearchSPActivity.class);
            ...
            Intent intent = new Intent(SPProductDetailsActivity.this, SPCartActivity.class);
            startActivity(intent);
            finish();
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(SPProductDetailsActivity.this, ServiceProviderDashboardActivity.class);
        intent.putExtra("tag",tag);
        startActivity(intent);
        finish();
    ...
    public void onClick(View v) {
        switch (v.getId()){
                case R.id.img_cart:
                    Intent i = new Intent(getApplicationContext(), SPCartActivity.class);
                ...
                case R.id.img_profile:
                    ...
                    if(ServiceProviderDashboardActivity.active_tag != null){
                        intent.putExtra("active_tag",ServiceProviderDashboardActivity.active_tag);
            ...
            case R.id.img_fav:
                if (new ConnectionDetector(SPProductDetailsActivity.this).isNetworkAvailable(SPProductDetailsActivity.this)) {
