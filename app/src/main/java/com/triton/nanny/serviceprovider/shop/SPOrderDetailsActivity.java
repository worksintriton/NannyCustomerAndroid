package com.triton.nanny.serviceprovider.shop;
...
public class SPOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  bottom_navigation_view.getMenu().findItem(R.id.shop).setChecked(true);
        ...
        if (new ConnectionDetector(SPOrderDetailsActivity.this).isNetworkAvailable(SPOrderDetailsActivity.this)) {
        ...
        txt_cancell_order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), SPCancelOrderActivity.class);
